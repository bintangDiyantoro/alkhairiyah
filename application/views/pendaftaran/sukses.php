    ...
    <div class="row d-flex justify-content-center">
        <div class="col-lg-7">
            <div class="alert alert-light" role="alert">
                ...
                <hr>
                <a class="btn btn-info mb-2" href="<?= base_url('pendaftaran/cetak/') . $id ?>" target="_blank">Download bukti pendaftaran</a> &nbsp;
                <a class="btn btn-success mb-2" href="https://chat.whatsapp.com/G3sn2t1ji2d0FcfcHRtdNv" target="_blank">Masuk grup WhatsApp</a> &nbsp;
