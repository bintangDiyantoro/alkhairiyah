<div class="card-2 d-flex justify-content-center mt-4 py-4" style="overflow-x: auto;">
    <div class="col-md-11">
        ...
        <div class="row">
            ...
            <?= str_ireplace('<p>', '<p style="width:100%;display:block">', str_ireplace('watch?v=', 'embed/', str_ireplace('youtu.be', 'www.youtube.com/embed', str_ireplace('url', 'src', str_ireplace('oembed', 'iframe', $materi["material"]))))) ?>
        </div>
        <div class="row">
        ...
        <?php if ($materi["questions"]) : ?>
            <div class="row">
                ...
                <?php
                $link = str_ireplace('</p>', '', strchr($materi["questions"], 'http'));
