...
<div class="row d-flex justify-content-end">
    <button class="btn btn-info update-pengetahuan-keterampilan ubah-nilai-pengetahuan-keterampilan mr-1" type="submit" name="submit" id="simpanNilaiPengetahuanKeterampilan" data-session="<?= $this->session->userdata("admin") ?>">Simpan</button>
    </form>
