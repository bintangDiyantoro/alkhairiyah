<div class="row tb-absensi-flex-container d-flex justify-content-center">
...
<div class="row d-flex justify-content-end">
    <button class="btn btn-info update-absensi ubah-jumlah-absensi mr-1" type="submit" name="submit" id="simpanJumlahAbsensi" data-session="<?= $this->session->userdata("admin") ?>"><i class="fas fa-save"></i> Simpan</button>
    </form>
